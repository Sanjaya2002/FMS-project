...
// import React, {useEffect, useState} from 'react';
// import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
// import {faCheck, faEllipsisVertical, faTrash} from '@fortawesome/free-solid-svg-icons';
// import { FaTrash } from "react-icons/fa";
// import { FaCircleCheck } from "react-icons/fa6";
//
// function OfficerOverview() {
//     const [todayIssuedFines, setTodayIssuedFines] = useState([
//         { id: 1, msgText: "Fine Issued for LC110456", time: "7.00 AM", isRead: false, isSelected: false },
//         { id: 2, msgText: "Fine Issued for LC110456", time: "7.30 AM", isRead: false, isSelected: false },
//         { id: 3, msgText: "Fine Issued for LC110456", time: "8.00 AM", isRead: false, isSelected: false },
//         { id: 4, msgText: "Fine Issued for LC110456", time: "7.15 AM", isRead: false, isSelected: false },
//         { id: 5, msgText: "Fine Issued for LC110456", time: "7.45 AM", isRead: false, isSelected: false },
//         { id: 6, msgText: "Fine Issued for LC110456", time: "7.00 AM", isRead: false, isSelected: false },
//         { id: 7, msgText: "Fine Issued for LC110456", time: "7.30 AM", isRead: false, isSelected: false },
//         { id: 8, msgText: "Fine Issued for LC110456", time: "8.00 AM", isRead: false, isSelected: false },
//         { id: 9, msgText: "Fine Issued for LC110456", time: "7.15 AM", isRead: false, isSelected: false },
//         { id: 10, msgText: "Fine Issued for LC110456", time: "7.45 AM", isRead: false, isSelected: false },
//         { id: 11, msgText: "Account Verified Successfully", time: "9.00 PM", isRead: false, isSelected: false },
//         { id: 12, msgText: "Account Created Successfully", time: "2.00 PM", isRead: true, isSelected: false },
//     ]);
//
//     const [showCheckBox,setShowCheckBox] = useState(false);
//
//     const allIssuedFines = [...todayIssuedFines];
//
//     const notificationSettings = [
//         { optionText: "Mark All as read", icon: <FaCircleCheck />, action: "markAsRead" },
//         { optionText: "Delete All Notifications", icon: <FaTrash />, action: "deleteSelected" },
//     ];
//
//     const toggleSelectMessage = (id) => {
//         setTodayIssuedFines(prev =>
//             prev.map(msg => msg.id === id ? { ...msg, isSelected: !msg.isSelected } : msg)
//         );
//     };
//
...
//         setTodayIssuedFines(prev =>
//             prev.map(msg => msg.isSelected ? { ...msg, isRead: true, isSelected: false } : msg)
//         );
//     };
//
//     const deleteSelectedMessages = () => {
//         setTodayIssuedFines(prev =>
//             prev.filter(msg => !msg.isSelected)
//         );
//     };
//
...
//     }
//
//     useEffect((anySelected) => {
//         const deleteButton = document.getElementById("deleteButton");
//         anySelected = todayIssuedFines.some(item => item.isSelected);
//
//         if (deleteButton) {
...
//                         {anySelected && (
//                             <button
//                                 className="me-3 mt-1 rounded p-2 d-flex justify-content-end align-content-center border-0"
//                                 style={{ width: "fit-content", height: "fit-content", backgroundColor: "#d3e2fd" }}
...
//                             className="me-3 mt-1 rounded p-2 d-flex justify-content-end align-content-center border-0"
//                             style={{width: "fit-content", height: "fit-content", backgroundColor: "#d3e2fd"}}>
//                             <FontAwesomeIcon icon={faCheck} className="fs-4" onClick={handleCheckbox}/>
//                         </button>
//                         <button
//                             className="me-3 rounded px-3 py-2 d-flex justify-content-end align-content-center border-0"
//                             style={{width: "fit-content", height: "fit-content", backgroundColor: "#d3e2fd"}}>
//                             <FontAwesomeIcon icon={faEllipsisVertical} className="fs-3"/>
//                         </button>
//                     </div>
...
//                                         onChange={() => toggleSelectMessage(item.id)}
//                                         className="me-1" style={{width:"5%"}}
//                                     />
//                                 )}
//                                 <button className="d-flex justify-content-between w-100 border-0 bg-white"
//                                         style={{textAlign: "start"}}>
//                                     <span className={`d-flex ${item.isRead ? "text-muted" : "fw-bold"}`}>
//                                         {item.msgText}
//                                     </span>
//                                     <span className="text-muted small justify-content-end text-end">{item.time}</span>
//                                 </button>
//                             </li>
//                         ))}
//                     </ul>
...
//                 <div className="search-section container"
//                      style={{ backgroundColor: "#d3e2fd", borderRadius: "10px", padding: "0px" }}>
//                     <h5 className="fw-bold" style={{ margin: "7px" }}>All Issued Fines</h5>
//                     <ul className="list-group list-group-flush" style={{ maxHeight: "75vh", borderRadius: "10px" }}>
//                         {allIssuedFines.map((item) => (
//                             <li key={item.id} className="list-group-item d-flex w-100">
//                                 <span className="d-flex justify-content-start">{item.msgText}</span>
//                                 <span className="text-muted small justify-content-end text-end">{item.time}</span>
//                             </li>
//                         ))}
//                     </ul>
...
//                                 <button
//                                     className="d-flex border-0 bg-light w-100"
//                                     onClick={() => handleNotificationAction(item.action)}
//                                 >
//                                     <span className="d-flex justify-content-start align-content-center mt-1" style={{ width: "15%", textAlign: "center" }}>
//                                         {item.icon}
//                                     </span>
